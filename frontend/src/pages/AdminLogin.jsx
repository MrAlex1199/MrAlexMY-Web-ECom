...
export default function AdminLogin({ setIsAdmin, setAdminData }) {
    ...
    const handleLogin = async () => {
      try {
        ...
        if (response.ok) {
          ...
          setIsAdmin(true);
          setAdminData({ fname: data.fname, lname: data.lname });
    ...
    return (
        <div>
            ...
            <form onSubmit={(e) => { e.preventDefault(); handleLogin(); return false; }}>
                <div className="bg-white dark:bg-gray-900">
                    <div className="container flex items-center justify-center min-h-screen px-6 mx-auto">
                        <form className="w-full max-w-md" onSubmit={handleLogin}>
                            <img className="w-auto h-7 sm:h-8" src={logo} alt="login"/>
                            <h1 className="mt-3 text-2xl font-semibold text-gray-800 capitalize sm:text-3xl dark:text-white">AdminDashBoard</h1>
                            ...
                            <div className="mt-6">
                                ...
                                <div className="mt-6 text-center ">
                                    <Link to="/admin-register" className="text-sm text-blue-500 hover:underline dark:text-blue-400">
